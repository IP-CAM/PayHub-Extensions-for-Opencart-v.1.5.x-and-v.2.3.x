      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="payhub_org_id" value="<?php echo $payhub_org_id; ?>" />
              <?php if ($error_org_id) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="payhub_username" value="<?php echo $payhub_username; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="payhub_password" value="<?php echo $payhub_password; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="payhub_terminal_id" value="<?php echo $payhub_terminal_id; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="payhub_invoice_prefix" value="<?php echo $payhub_invoice_prefix; ?>" />
              <?php if ($error_invoice_prefix) { ?>
              <span class="error"><?php echo $error_invoice_prefix; ?></span>
              <?php } ?></td>
          </tr>
          <tr>
            <td><?php echo $entry_total; ?></td>
            <td><input type="text" name="payhub_total" value="<?php echo $payhub_total; ?>" /></td>
          </tr>
          <tr>
